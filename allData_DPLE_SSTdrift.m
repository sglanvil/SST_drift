...
for imember=1:length(memberList)
    ...
    fil=sprintf('/glade/work/sglanvil/CCR/SST_drift/CESM1_FOSI_FULL/ts_cesm1_fosi_%s_ALL.nc',...
        memberList{imember});
    raw=ncread(fil,'TS');
%     fil=sprintf('/glade/work/sglanvil/CCR/SST_drift/CESM1_FOSI_FULL/trefht_cesm1_fosi_%s_ALL.nc',...
%         memberList{imember});
...
raw=ncread(fil,'TS');
% fil='/glade/work/sglanvil/CCR/SST_drift/CESM1LE/extend_TREFHT_CESM1LE_192001-208012.nc';
% raw=ncread(fil,'TREFHT');
...
save('/glade/work/sglanvil/CCR/SST_drift/matlab_files/varYearlyOut_cesm1_fosi_full_TS_2022.mat',...
    'varYearlyCLIM_LE','timeCLIM_LE','name_LE',...
    'varYearly_FORECAST','time_FORECAST','name_FORECAST',...
    'varYearlyOBS','timeOBS',...
